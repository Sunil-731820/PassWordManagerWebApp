                ...
                <div class="container"> 
                    <div class="signup-content"> 
                        <div class="signup-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="userLoginPassword" name="userLoginPassword" id="userLoginPassword" placeholder="Your Password Please " required="required"/>
                                </div>
                        ...
                        <div class="signup-image">
                            ...
                            <h2><a href="LoginAndRegistration/LoginPage.jsp" class="signup-image-link">Log In</a></h2>
                        </div>
                    </div>
                </div>
            </section>
